...
BroadcastMessage::BroadcastMessage(const MessageType messageType, const byte* content, const byte contentLength)
{
	_type = messageType;
	_content = content;
...
byte* BroadcastMessage::GetContent() const
{
	return _content;
}

byte BroadcastMessage::GetContentLength() const
{
